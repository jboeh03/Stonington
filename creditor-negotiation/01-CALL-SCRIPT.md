# Call Script — AmEx Judgments (read aloud)
...
> "Hi, my name is **Jeffrey Boeh**. You have two judgments against me that I believe your firm is
> handling — case numbers **CJ25-022895** and **CJ25-025962**, both American Express accounts.
> I'd like to speak with someone about **resolving both of them today**. Who's the right person?"

When you reach the right person, get their name:
> "Before we start — can I get your name and a direct number or extension, in case we get cut off?"
> *(Write it down.)*

---

## 2) Set the frame (hardship, voluntary, lump sum)

> "I'll be straight with you. I've had a rough stretch financially and I'm trying to clean things
> up and put this behind me. I can't pay these in full — that's just not realistic for me. But I've
> been able to pull together some money, partly from family, and I'd rather use it to **settle
> these voluntarily** than have everyone fight over scraps. I'm hoping we can agree on a **one-time
> lump-sum settlement** on both accounts today."

*(Keep it short. Don't over-explain. Do not mention the house or the divorce.)*
...
## 4) Branches — how to respond

### A) "That's far too low / we can only knock off a little."
> "I understand it's lower than you'd like. But this is essentially **borrowed money** — it's the
> most I can put my hands on. Realistically, what's the lowest you can take to make both of these
> go away today?"

Step up **slowly** — $13k… $15k… toward your $16k–$18k target. Never jump straight to your max.
> "I might be able to get to **$15,000** if that closes out **both** accounts with a satisfaction
...
> it and just talk settlement numbers — that's why I called instead of waiting for you to chase it."

### E) They get aggressive / threaten garnishment or seizure.
Stay calm.
> "You're welcome to pursue whatever remedies you have — I understand that. I'm trying to save us
> both the time and expense by settling today. If garnishment or anything else is on the table, then
> all the more reason to lock in a number now. So — can we agree on a lump sum, yes or no?"

### F) They'll only do a payment plan, not a discount.
> "If a deep lump-sum discount isn't possible, I'd consider a **short** structured deal — say
> **40%, paid over 60 to 90 days** — but only if the agreement says you **won't file a certificate
